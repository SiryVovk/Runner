...
The player continuously moves forward while avoiding obstacles. During the run, obstacles are spawn dynamically to maintain the gameplay loop.
If the player loses, the game enters a defeat state. At that point, the player can continue the run by watching a rewarded ad.
...
![Gameplay GIF](https://github.com/user-attachments/assets/f23cb55f-c44e-4697-81bf-438b88fd5e74)
